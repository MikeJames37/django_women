...
def about(request):
    ...
    return render(request, 'women/about.html', {'title': 'About', 'page_obj': page_obj})
...
class ShowPost(DataMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        return self.get_mixin_contest(context, title=context['post'].title)
...
class WomenCategory(DataMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        return self.get_mixin_contest(context,
